...
# This file is at: mistral/config.py
# Project root is one level up
PROJECT_ROOT = Path(__file__).parent.parent.resolve()
MISTRAL_ROOT = Path(__file__).parent.resolve()

# Mistral-specific directories
CHECKPOINTS_DIR = MISTRAL_ROOT / "checkpoints"
...
# Dataset path
DATASET_DIR = MISTRAL_ROOT / "dataset_ultrachat"
...
if __name__ == "__main__":
    ...
    print(f"Mistral Root: {MISTRAL_ROOT}")
