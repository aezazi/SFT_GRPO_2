...
SFT_CHECKPOINTS_DIR = MISTRAL_SFT_ROOT / "checkpoints"
SFT_LOGS_DIR = MISTRAL_SFT_ROOT / "logs"
SFT_EXPERIMENTS_DIR = MISTRAL_SFT_ROOT / "experiments"
...
def ensure_directories():
    ...
    for directory in [SFT_CHECKPOINTS_DIR, SFT_LOGS_DIR, SFT_EXPERIMENTS_DIR]:
