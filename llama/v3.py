...
training_args = SFTConfig(
    output_dir="./llama3.2-base-customer-service-chat",
    num_train_epochs=3,
...
# Save
trainer.save_model("./llama3.2-base-customer-service-chat-final")
tokenizer.save_pretrained("./llama3.2-base-customer-service-chat-final")
print("✅ Model saved!")
